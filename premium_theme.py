...
def inject_premium_theme():
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .block-container {
        padding: 0.75rem 2.5rem 5rem !important;
        max-width: 1480px !important;
...
def render_page_header(title: str, subtitle: str = ""):
    ...
    <div style="margin-bottom:2rem;padding-bottom:1.75rem;position:relative">
        <h1 style="margin:0;font-size:3.1rem;font-weight:900;letter-spacing:-0.05em;
                   line-height:1.04;
...
CHARGED_COLOR_PREMIUM = "#00F07A"   # Bright green — exclusive to charged dots
